...
\hline[1pt]
\multicolumn{6}{|c|}{\Large\bfseries Teoría de Números y Aplicaciones pág. \pageref{reg-1708}}\\
\hline
\hline
...
\raggedcolumns
%%%%%%%%%%1708%%%%%%%%%%%
\noindent  \ref{reg-1708}  {\bfseries Haciendo teor\'{\i}a de n\'umeros con sistemas algebraicos computacionales (CAS)}\\
...
{\slshape  Robert Oyono} {\footnotesize (CPI, Seleccionar)}\\
...
{\slshape  Martha  Rzedowski Calderón} {\footnotesize (Seleccionar, Seleccionar)}\\
...
{\slshape  Horacio  Tapia-Recillas (Invitado)} {\footnotesize (CDV, Seleccionar)}\\
...
%%%%%%%%%%765%%%%%%%%%%%
\noindent  \ref{reg-765}  {\bfseries El anillo de adeles como un espacio métrico}\\
{\slshape  Sergii  Torba} {\footnotesize (CI, Pos)}\\

%%%%%%%%%%488%%%%%%%%%%%
\noindent  \ref{reg-488}  {\bfseries Sumas Exponenciales Mod $p^m$ para polinomios de Laurent}\\
